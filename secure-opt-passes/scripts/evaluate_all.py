...
def evaluate_method(c_file: str, method: str, llvm: LLVMWrapper, oracle: SecurityOracle):
    """
...
def run_evaluation(benchmark_dir: str, output_dir: str, 
    ...
    for c_file in tqdm(c_files, desc="Benchmarks"):
        ...
        for method in methods:
            result = evaluate_method(str(c_file), method, llvm, oracle)
...
def main():
    ...
    parser.add_argument("--methods", default="O0,O2,O3,greedy,random",
